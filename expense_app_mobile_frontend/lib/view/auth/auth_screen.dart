          ...
          return SizedBox(
            ...
            child: Column(
              ...
              children: [
                ...
                InkWell(
                  onTap: () async {
                    authBloc.add(const GoogleLoginEvent());
                  },
                  child: Container(
                    ...
                    child: (state is GoogleLoginLoadingState)
                        ? const Center(
                            child: SizedBox(
                                height: 20,
                                width: 20,
        ...
        listener: (context, state) {
          if (state is GoogleLoginErrorState) {
            ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(content: Text("Error, While Google Login.")));
          }
          if (state is GoogleLoginSuccessfulState ||
              state is NewGoogleLoginSuccessfulState) {
            ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                content: Text("Success, You Logged in Successfully.")));
